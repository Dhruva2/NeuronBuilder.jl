...
struct Na{F<:Real,D} <: FlowChannel(Sodium)
    gNa::D
    mNa::F
    hNa::F
end
...
struct CaS{F<:Real,D} <: FlowChannel(Calcium)
    gCaS::D
    mCaS::F
    hCaS::F
end
...
struct CaT{F<:Real,D} <: FlowChannel(Calcium)
    gCaT::D
    mCaT::F
    hCaT::F
end
...
struct Ka{F<:Real,D} <: FlowChannel(Potassium)
    gKa::D
    mKa::F
    hKa::F
end
...
struct KCa{F<:Real,D} <: FlowChannel(Calcium, Potassium)
    gKCa::D
    mKCa::F
end
...
struct Kdr{F<:Real,D} <: FlowChannel(Potassium)
    gKdr::D
    mKdr::F
end
...
struct H{F<:Real,D} <: FlowChannel(Proton)
    gH::D
    mH::F
end
