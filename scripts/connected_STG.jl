...
comp1 = Soma(Dict(:V => -60.0, :Ca => 0.05), merge(reversals, params))
comp2 = Soma(Dict(:V => -55.0, :Ca => 0.05), merge(reversals, params))
comp3 = Soma(Dict(:V => -65.0, :Ca => 0.05), merge(reversals, params))
